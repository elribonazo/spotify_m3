...
module.exports = {
		...
		getalbumstracks : function(artists, callback){
			...
			for(i=0;i<artists.length;++i){
				...
				module.exports.gettracks(artist.albums, function(albums){
			...
			get = function () {
				...
				module.exports.get(query, function(err, tracks){
					...
					for(x=0;x<items.length;++x){
						...
						var info = {};
						info.name = items[x].name;
						info.track_number = items[x].track_number;
						info.id = items[x].id;
						info.uri = items[x].tracks;
